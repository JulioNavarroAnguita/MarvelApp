...
const val GET_CHARACTERS_FROM_DATABASE_UC_TAG = "getCharactersFromDatabaseUc"

class GetCharactersFromDatabaseUc(private val characterRepository: DomainLayerContract.DataLayer.CharacterRepository) :
